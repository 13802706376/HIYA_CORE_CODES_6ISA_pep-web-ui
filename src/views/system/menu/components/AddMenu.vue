<template>
  <div class="dialog-add-menu">
    <el-dialog title="新增菜单" width="35%" :visible.sync="dialogFormVisible">
      <el-form ref="menuForm" :rules="rules" :model="menus" label-position="right" label-width="120px" style="width: 450px; margin-left:50px;">
        <el-form-item label="上级菜单：" class="set-pointer" prop="parent.name">
          <el-input style="width:260px;cursor:pointer;" :value="menus.parent.name" @click.native="chooseMenu" size="small" readonly/>
        </el-form-item>
...
export default {
  ...
  methods: {
    isShow(dialogFormVisible,menu){
      this.dialogFormVisible = dialogFormVisible
      this.menus.parent = menu
    },
    chooseMenu(){
